                ...
                <div class="form-group-row" style="margin-bottom: 10px; display: flex; gap: 10px;">
                    <div class="form-group" style="flex: 1;">
                        <select id="opleiding" name="opleiding" style="width: 100%; max-width: 280px;">
                            ...
                            <option value="opleiding1">Media vormgeving</option>
                            <option value="opleiding2">Interieuradviseur</option>
                            <option value="opleiding3">Podium-en Evenemententechniek</option>
                            <option value="opleiding4">Muzikant</option>
                            <option value="opleiding5">Acteur</option>
                            <option value="opleiding6">Expert IT systems and devices</option>
                            <option value="opleiding7">Software developer</option>
                            <option value="opleiding8">AV-productie</option>
                            <option value="opleiding9">Fotograaf</option>
                            <option value="opleiding10">Mode</option>
                            <option value="opleiding11">Creative Developer</option>
                        </select>
                    </div>
                    <div class="form-group" style="flex: 1;">
